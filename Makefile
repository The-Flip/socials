...
help:
	...
	@echo "  make quality      - Lint, format, and typecheck"
...
# Lint (with --fix) before format, per Ruff's guidance and matching .pre-commit-config.yaml —
# fixes can produce code that then needs reformatting.
